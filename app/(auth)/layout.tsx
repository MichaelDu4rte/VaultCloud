...
const Layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex min-h-screen">
      <section className="hidden w-1/2 items-center justify-center bg-brand px-12 py-16 lg:flex xl:w-2/5">
      ...
      <section className="flex flex-1 flex-col items-center bg-white px-6 py-10 lg:justify-center lg:px-12 lg:py-0">
